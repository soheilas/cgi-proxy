...
sub mini_start_form {
	...
	return <<EOF ;
<table width=100% bgcolor="#D1EEEE" border=0 cellspacing=0 cellpadding=2>
<tr>
<td align=center valign=center width=160>
<a href=/ style="text-decoration: none"><h2 style="font-family: Arial;">asdf</h2></a>
</td>
<td>
<form action="$action" method=$method target="_top">
<center>
Location&nbsp;via&nbsp;proxy: <input name="URL" size=66 value="$safe_URL"><input type=submit value="Browse">
$up_link
